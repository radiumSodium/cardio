...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col gap-20 pb-20">
      ...
      {/* About Section */}
      <section id="about" className="container mx-auto px-4 scroll-mt-28">
      ...
      <section id="services" className="container mx-auto px-4 scroll-mt-28">
         <div className="flex justify-between items-end mb-16">
            <h2 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-pink-500">
               Featured Services
            </h2>
            <Link href="/services" className="text-blue-400 hover:text-blue-300 transition font-medium">
               View All Services →
            </Link>
         </div>
      ...
      <section className="container mx-auto px-4 text-center">
         ...
         <div id="contact" className="flex flex-wrap justify-center gap-8 scroll-mt-28">
